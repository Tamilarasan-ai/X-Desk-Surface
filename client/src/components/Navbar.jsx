...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-white  border-gray-200 py-2.5 dark:bg-gray-900 navbar backdrop-filter backdrop-blur-lg bg-opacity-[0.4!important]">
        <div className="flex flex-wrap  items-center justify-between max-w-screen-xl px-4 mx-auto">
          <a href="#" className="flex items-center">
            <img
              src={logo}
              className="h-18 mr-3  rounded-full sm:h-9"
              alt="Landwind Logo"
            />
